...
console.log("Starting Experimental Plangonaut Standalone Executable Build (Node SEA)...");
console.log("Evaluation for OD-004: Node SEA currently requires CommonJS entry points.");
console.log("Since Plangonaut uses native ESM (import.meta.url and top-level await), a bundler workaround");
